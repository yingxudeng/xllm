...
RotaryEmbeddingImpl::RotaryEmbeddingImpl(int rotary_dim,
  ...
  std::cerr << "dyx-debug freqs.sizes() " << freqs.sizes() << std::endl;
...
void RotaryEmbeddingImpl::forward(torch::Tensor& q,
                                  ...
                                  int max_query_len,
                                  bool is_prompt) {
  std::cerr << "dyx-debug RotaryEmbeddingImpl::forward called" << std::endl;
  std::cerr << "dyx-debug query shape before view:" << q.sizes() << std::endl;
  std::cerr << "dyx-debug key shape before view:" << k.sizes() << std::endl;
  bool discrete;
  ...
  std::cerr << "dyx-debug RotaryEmbeddingImpl::forward cos_sin shape:"
            << cos_sin.sizes() << std::endl;
  ...
  std::cerr << "dyx-debug RotaryEmbeddingImpl::forward cos_ shape:"
            << cos_.sizes() << std::endl;
  std::cerr << "dyx-debug RotaryEmbeddingImpl::forward sin_ shape:"
            << sin_.sizes() << std::endl;
  std::cerr << "dyx-debug RotaryEmbeddingImpl::forward k shape:" << k.sizes()
            << std::endl;
  std::cerr << "dyx-debug RotaryEmbeddingImpl::forward q shape:" << q.sizes()
            << std::endl;
  // sleep(1);
