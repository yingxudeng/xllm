...
struct SM120DispatchConfig {
  ...
  static constexpr uint32_t kMediumM = 32;
  static constexpr uint32_t kLargeM = 128;
  static constexpr uint32_t kVeryLargeM = 256;

  // N/K thresholds for swap_ab decision
  static constexpr uint32_t kLargeN = 8192;
  static constexpr uint32_t kLargeK = 4096;

  // Wave efficiency threshold
  static constexpr float kMinWaveEfficiency = 0.75f;
  static constexpr float kEfficiencyMargin = 0.05f;

  // Default SM count fallback
