...
npu_mla_preprocess_out(const at::Tensor& input,
  ...
  auto cache_mode = atb::utils::get_op_mode(
      cache_mode_map, cache_mode_opt, "krope_ctkv", "cache_mode");
  auto quant_mode = atb::utils::get_op_mode(
      quant_mode_map, quant_mode_opt, "per_token_quant_symm", "quant_mode");
  EXEC_ATB_CMD(AtbMLAPreprocess,
               input,
               gamma0,
               beta0,
               quant_scale0,
...
std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor> npu_mla_preprocess(
  ...
  if (cache_mode == 2 || cache_mode == 3) {
    kv_cache_out0 = at_npu::native::empty_with_format(
        kv_cache.sizes(), kv_cache.options(), ACL_FORMAT_FRACTAL_NZ);
    kv_cache_out1 = at_npu::native::empty_with_format(
        kv_cache_rope.sizes(), kv_cache_rope.options(), ACL_FORMAT_FRACTAL_NZ);
  } else {
...
TORCH_LIBRARY_FRAGMENT(atb, m) {
  m.def(
      "npu_mla_preprocess(Tensor input, Tensor gamma0, Tensor beta0, Tensor "
      "wdqkv, Tensor descale0, Tensor gamma1, Tensor beta1, Tensor wuq, Tensor "
      "descale1, Tensor gamma2, Tensor cos, Tensor sin, Tensor wuk, Tensor "
      "kv_cache, Tensor kv_cache_rope, Tensor slotmapping, *,  Tensor? "
      "quant_scale0=None, Tensor? quant_offset0=None, Tensor? bias0=None, "
      "Tensor? quant_scale1=None, Tensor? quant_offset1=None, Tensor? "
      "bias1=None, Tensor? ctkv_scale=None, Tensor? q_nope_scale=None, str? "
      "cache_mode=None, str? quant_mode=None) -> (Tensor, Tensor, Tensor, "
      "Tensor)");
  m.def(
      "npu_mla_preprocess.out(Tensor input, Tensor gamma0, Tensor beta0, "
      "Tensor wdqkv, Tensor descale0, Tensor gamma1, Tensor beta1, Tensor wuq, "
      "Tensor descale1, Tensor gamma2, Tensor cos, Tensor sin, Tensor wuk, "
      "Tensor kv_cache, Tensor kv_cache_rope, Tensor slotmapping, *,  Tensor? "
      "quant_scale0=None, Tensor? quant_offset0=None, Tensor? bias0=None, "
      "Tensor? quant_scale1=None, Tensor? quant_offset1=None, Tensor? "
      "bias1=None, Tensor? ctkv_scale=None, Tensor? q_nope_scale=None, str? "
      "cache_mode=None, str? quant_mode=None, Tensor(a!) q_out0, Tensor(b!) "
      "kv_cache_out0, Tensor(c!) q_out1, Tensor(d!) kv_cache_out1) -> "
