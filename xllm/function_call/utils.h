...
// Allow flags for partial JSON parsing (exactly matching sglang's Allow enum)
enum class Allow : int {
  ...
  // Composite options - exactly matching sglang
...
// Utility functions matching sglang's utils.py exactly
